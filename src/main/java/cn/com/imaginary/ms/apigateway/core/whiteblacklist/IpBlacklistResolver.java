...
public class IpBlacklistResolver {
    ...
    public ReturnData getIpList() {
        ...
        return ReturnDataUtil.getSuccussReturn(result);
    }

    public ReturnData addIp(String ip, String remark) {
    ...
    public ReturnData delIp(String ip) {
